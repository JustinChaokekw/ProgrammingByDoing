...
{
	// 1. Yes.
	// 2. The HeronsFormulaNoFunction.java has 50 lines, while HeronsFormula.java only has 32 lines
	// 3. It is easier to fix the code in the file with function.
	// 4. It is easier to fix the code in the file with function.
